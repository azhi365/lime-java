...
public class ColorTableCellEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    public ColorTableCellEditor() {
        ...
        colorDialog = JColorChooser.createDialog(null, "Planet Color", false, colorChooser, EventHandler.create(ActionListener.class, this, "stopCellEditing"), EventHandler.create(ActionListener.class, this, "cancelCellEditing"));
    }
