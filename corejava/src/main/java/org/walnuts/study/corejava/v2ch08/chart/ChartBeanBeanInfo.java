package org.walnuts.study.corejava.v2ch08.chart;
...
public class ChartBeanBeanInfo extends SimpleBeanInfo {
    ...
    public ChartBeanBeanInfo() {
        ...
        try {
            ...
            propertyDescriptors = new PropertyDescriptor[]{new PropertyDescriptor("title", ChartBean.class), titlePositionDescriptor, valuesDescriptor, new PropertyDescriptor("graphColor", ChartBean.class), inverseDescriptor};
