package org.walnuts.study.corejava.v2ch10.bytecodeAnnotations;
...
/**
 * Adds "entering" logs to all e17_methods of a class that have the LogEntry annotation.
 *
...
public class EntryLogger {
    ...
    /**
     * Constructs an EntryLogger that inserts e2_logging into annotated e17_methods of a given class.
     *
     * @param cg the class
     */
    ...
    /**
     * Adds entry e2_logging code to the given class.
     *
    ...
    /**
     * converts the class by inserting the e2_logging calls.
     */
    ...
    private Method insertLogEntry(Method m, String loggerName) {
        ...
        System.out.printf("Adding e2_logging instructions to %s.%s%n", className, methodName);

        int getLoggerIndex = cpg.addMethodref("java.util.e2_logging.Logger", "getLogger", "(Ljava/lang/String;)Ljava/util/e2_logging/Logger;");
        int enteringIndex = cpg.addMethodref("java.util.e2_logging.Logger", "entering", "(Ljava/lang/String;Ljava/lang/String;)V");
