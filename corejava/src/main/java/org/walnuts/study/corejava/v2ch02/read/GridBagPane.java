package org.walnuts.study.corejava.v2ch02.read;
...
public class GridBagPane extends JPanel {
    ...
    private void parseCell(Element e, int r, int c) {
        ...
        // use e13_reflection to get integer values of static fields
        ...
        } catch (Exception ex) // the e13_reflection e17_methods can throw various exceptions
        {
            ex.printStackTrace();
        }
