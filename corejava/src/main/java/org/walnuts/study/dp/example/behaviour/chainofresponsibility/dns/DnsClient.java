...
public class DnsClient {
	...
	public void testDnsObserver() {
		org.walnuts.study.dp.example.behaviour.observer.dns.DnsServer sh = new org.walnuts.study.dp.example.behaviour.observer.dns.SHDnsServer();
		org.walnuts.study.dp.example.behaviour.observer.dns.ChinaTopDnsServer china = new org.walnuts.study.dp.example.behaviour.observer.dns.ChinaTopDnsServer();
		org.walnuts.study.dp.example.behaviour.observer.dns.TopDnsServer top = new org.walnuts.study.dp.example.behaviour.observer.dns.TopDnsServer();
