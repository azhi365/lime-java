 ...
 * 线程组
 */
public class ThreadGroupStart {

    public static void main(String[] args) {

        java.lang.ThreadGroup threadGroup = new java.lang.ThreadGroup("Searcher");
     ...
     * @param threadGroup
     */
    private static void waitFinish(java.lang.ThreadGroup threadGroup) {
